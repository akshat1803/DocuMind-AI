...
describe('Markdown answer citations', () => {
  it('turns only saved citation markers into internal links', () => {
    const citations = [{
      id: 'citation-1', citationNumber: 1, excerpt: 'Source text', similarityScore: 0.9, chunkId: 'chunk-1', documentId: 'document-1', documentName: 'Source.pdf', pageStart: 1, pageEnd: 1, sourceDeleted: false,
    }];
